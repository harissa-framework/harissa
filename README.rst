...
from :math:`t = 0h` to :math:`t = 10h` can be simulated using:
...
Each group of cells collected at the same experimental time :math:`t_k` 
forms a *snapshot* of the biological heterogeneity at time :math:`t_k`. 
