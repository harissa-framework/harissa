...
class NetworkModel:
    ...
    def fit(self, data, l=1, tol=1e-5, verb=False, use_numba=True):
        ...
        if use_numba:
            from ..inference.network_fast import infer_network
        else:
            from ..inference.network import infer_network
        # Inference procedure
    ...
    def simulate(self, t, M0=None, P0=None, burnin=None, verb=False,
        ...
        if use_numba:
            from ..simulation.pdmp_fast import BurstyPDMP
        else:
            from ..simulation.pdmp import BurstyPDMP
        a = self.a
        d = self.d
        basal = self.basal
        inter = self.inter
